...
import {  sphereMesh,planeMesh,multiMeshes, boxMesh,cubeBox } from "./geometry/index.js";
import {spotLight, pointLight} from "./lights/index.js"
...
function run() {
  ...
  box.rotateX(elapsed-time)
  box.rotateY(elapsed-time)
  // box.rotation.x=elapsed-time
